...
export class ProductDataDto {
  ...
  @ApiProperty({
    ...
    description:
      "These are all the attributes assigned to the Item by the Customer during purchase.",
  })
  ...
  @ApiProperty({
    ...
    description:
      "These are all the attributes of the purchased item generated by the integration and returned to the client.",
  })
  ...
  @ApiProperty({
    ...
    description:
      "This is the duration of the subscription the user has to the product in months.",
  })
  ...
  @ApiPropertyOptional({
    type: [IpDto],
    title:
      "The list of IPs connected to this product. Whether they are domains or others.",
  })
  ips?: IpDto[];
}
